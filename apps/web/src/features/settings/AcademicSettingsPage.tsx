...
// v0.3 (SPEC_V0.3.md §4 item 3): assessment structure + grading scale
// panels added, admin-only (PROPRIETOR/SCHOOL_ADMIN) — absent for
// TEACHER, same "absent not disabled" convention as the rest of the app's
// role-gated UI (Sidebar.tsx, RequireSchoolAdmin.tsx).
